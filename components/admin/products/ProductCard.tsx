...
import { MoreVertical, Edit, Copy, Archive, ExternalLink, AlertTriangle } from "lucide-react"
...
export function ProductCard({ product, onArchived, onDuplicated }: ProductCardProps) {
        ...
        <div className="mt-auto flex items-center gap-1.5">
          ...
          <div className="relative">
            <button
              ...
              disabled={!!loading}
              className="flex h-8 w-8 items-center justify-center rounded-xl border border-gray-200 text-gray-500 hover:bg-gray-50 disabled:opacity-60"
            >
              {loading ? (
            ...
            {menuOpen && (
              <>
                ...
                <div className="absolute right-0 bottom-full z-20 mb-1 w-44 rounded-xl border border-gray-200 bg-white shadow-lg py-1 text-sm">
                  <Link
                    href={`/${product.slug}`}
                    target="_blank"
